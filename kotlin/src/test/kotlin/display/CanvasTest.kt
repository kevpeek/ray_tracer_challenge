...
class CanvasTest {
    ...
    fun `Creating a canvas`() {
        val canvas = Canvas(Resolution(10, 20))
        assertEquals(10, canvas.resolution.hsize)
        assertEquals(20, canvas.resolution.vsize)
    ...
    fun `writing outside the canvas throws exception`() {
        val canvas = Canvas(Resolution(10, 10))
