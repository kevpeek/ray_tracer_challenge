...
fun main() {
    ...
    val runtime = measureTimeMillis {
        ...
        val middle = Sphere(WORLD_ORIGIN, middleMaterial).withTransform { middleTransform }

        val rightTransform = scaling(0.5, 0.5, 0.5).then(translation(1.5, 0.5, -0.5))
        val right = Sphere(WORLD_ORIGIN, middleMaterial).withTransform { rightTransform }
        ...
        val left = Sphere(WORLD_ORIGIN, leftMaterial).withTransform { leftTransform }
