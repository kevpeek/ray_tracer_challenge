...
impl Matrix {
    ...
    fn get_column(&self, column_index: usize) -> Vec<f64> {
        (0..self.height)
            .map(|row_index| self[row_index][column_index])
            .collect()
    }
    ...
    fn determinant(&self) -> f64 {
        ...
        if self.height == 2 && self.width == 2 {
            ...
            self.get_row(0)
                .iter()
                .enumerate()
                .map(|(column, value)| self.cofactor(0, column) * value)
                .sum()
        }
    }
...
impl<'a, 'b> Mul<&'b Matrix> for &'a Matrix {
    ...
    fn mul(self, rhs: &'b Matrix) -> Self::Output {
        let new_values: Vec<f64> = (0..self.height)
            .flat_map(|row_index| {
...
impl MatrixBuilder {
    pub fn of<T: NumCast>(self, values: Vec<T>) -> Matrix {
        let values = values.iter().map(|n| n.to_f64().unwrap()).collect();
        Matrix {
            width: self.width,
            height: self.height,
            values,
...
mod tests {
    ...
    fn test_not_equals() {
        ...
        let matrix_b =
            Matrix::of_size(4, 4).of(vec![2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4, 3, 2, 1]);
    ...
    fn test_multiplication() {
        ...
        let matrix_b =
            Matrix::of_size(4, 4).of(vec![-2, 1, 2, 3, 3, 2, 1, -1, 4, 3, 6, 5, 1, 2, 7, 8]);

        let expected_result = Matrix::of_size(4, 4).of(vec![
            20, 22, 50, 48, 44, 54, 114, 108, 40, 58, 110, 102, 16, 26, 46, 42,
        ]);

        assert_eq!(expected_result, &matrix_a * &matrix_b)
    }

    #[test]
    fn test_mul_by_point() {
        let matrix = Matrix::of_size(4, 4).of(vec![1, 2, 3, 4, 2, 4, 4, 2, 8, 6, 4, 1, 0, 0, 0, 1]);
    ...
    #[test]
    fn test_transpose() {
        let matrix = Matrix::of_size(4, 4).of(vec![0, 9, 3, 0, 9, 8, 0, 8, 1, 8, 5, 3, 0, 0, 5, 8]);

        let expected_transpose =
            Matrix::of_size(4, 4).of(vec![0, 9, 1, 0, 9, 8, 8, 0, 3, 0, 5, 5, 0, 8, 3, 8]);

        assert_eq!(expected_transpose, matrix.transpose())
    }
    ...
    fn test_determinant_2x2() {
        let matrix = Matrix::of_size(2, 2).of(vec![1, 5, -3, 2]);
    ...
    fn test_submatrix_3x3() {
        let matrix = Matrix::of_size(3, 3).of(vec![1, 5, 0, -3, 2, 7, 0, 6, -3]);

        let expected_sub = Matrix::of_size(2, 2).of(vec![-3, 2, 0, 6]);

        assert_eq!(expected_sub, matrix.submatrix(0, 2))
    }

    #[test]
    fn test_submatrix_4x4() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![-6, 1, 1, 6, -8, 5, 8, 6, -1, 0, 8, 2, -7, 1, -1, 1]);

        let expected_sub = Matrix::of_size(3, 3).of(vec![-6, 1, 6, -8, 8, 6, -7, -1, 1]);

        assert_eq!(expected_sub, matrix.submatrix(2, 1))
    }

    #[test]
    fn test_minor_3x3() {
        let matrix = Matrix::of_size(3, 3).of(vec![3, 5, 0, 2, -1, -7, 6, -1, 5]);
    ...
    fn test_determinant_3x3() {
        let matrix = Matrix::of_size(3, 3).of(vec![1, 2, 6, -5, 8, -4, 2, 6, 4]);
    ...
    fn test_determinant_4x4() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![-2, -8, 3, 5, -3, 1, 7, 3, 1, 2, -9, 6, -6, 7, 7, -9]);
    ...
    fn test_invertable() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![6, 4, 4, 4, 5, 5, 7, 6, 4, -9, 3, -7, 9, 1, 7, -6]);
    ...
    fn test_non_invertible() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![-4, 2, -2, -3, 9, 6, 2, 6, 0, -5, 1, -5, 0, 0, 0, 0]);
    ...
    fn test_inverse() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![-5, 2, 6, -8, 1, -5, 1, 8, 7, 7, -6, -7, 1, -3, 7, 4]);
    ...
    fn test_another_inverse() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![8, -5, 9, 2, 7, 5, 6, 1, -6, 0, 9, 6, -3, 0, -9, -4]);
    ...
    fn test_inverse_three() {
        let matrix =
            Matrix::of_size(4, 4).of(vec![9, 3, 0, 9, -5, -2, -6, -3, -4, 9, 6, 4, -7, 6, 6, 2]);
    ...
    fn test_multiple_product_by_inverse() {
        let matrix_a =
            Matrix::of_size(4, 4).of(vec![3, -9, 7, 3, 3, -8, 2, -9, -4, 4, 4, 1, -6, 5, -1, 1]);

        let matrix_b =
            Matrix::of_size(4, 4).of(vec![8, 2, 2, 2, 3, -1, 7, 0, 7, 0, 5, 4, 6, -2, 0, 5]);

        let matrix_c = &matrix_a * &matrix_b;

        assert_eq!(matrix_a, &matrix_c * &matrix_b.inverse())
    }
